...
|------------------------------------|-----------------------|---------------------------------------------------------|-----------------------------------------------------------|----------------------------------------------------------|
| **LeetCode-Rating-Predictor**       | Nov '23 - Dec '23     | React, FastAPI, Numpy, Pandas, Tensorflow, GraphQL        | [**Deploy**](https://leetcode-rating-predictor.onrender.com/) | [**Repo**](https://github.com/Sagargupta16/LeetCode_Rating_Predictor) |
...
| **Contact Manager React**          | Jul '22               | HTML, CSS, React, Redux, Router                           | [**Deploy**](https://sagargupta.me/Contact-Manager-React/)    | [**Repo**](https://github.com/Sagargupta16/Contact-Manager-React) |
